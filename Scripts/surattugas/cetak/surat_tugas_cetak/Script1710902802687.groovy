...
WebUI.verifyElementPresent(findTestObject('surattugas/cetak/table_header_status_print'), 0)

WebUI.verifyElementPresent(findTestObject('surattugas/cetak/btn_aksi_tabel_cetak'), 0)

WebUI.click(findTestObject('surattugas/cetak/btn_aksi_tabel_cetak'), FailureHandling.STOP_ON_FAILURE)
